    ...
    def post(self, request):
        ...
        try:
            ...
            response = cl.stk_push(
                phone_number,
                amount,
                "CaptivePortal",  # account ref - consider sending service_type if possible
                "Payment Service",
                callback_url
            )
            logger.info("STK Push Response: %s", response)
            # Do NOT create Payment here - wait for callback confirmation
    ...
    try:
        ...
        payment, created = Payment.objects.get_or_create(
            ...
            defaults={
                ...
                "reference": "payment",
                "user": user,
                "service_type": "generic"  # fallback, consider storing real service_type if possible
            }
        )
