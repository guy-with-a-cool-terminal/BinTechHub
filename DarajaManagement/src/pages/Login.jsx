  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-white">
      ...
      <div className="relative bg-white p-8 rounded-3xl shadow-xl w-full max-w-md mx-auto z-10">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-gray-800 mb-6">Daraja Credentials Manager</h2>
        <p className="text-sm sm:text-base md:text-lg text-gray-600 mb-6">Enter your credentials to access your Daraja API dashboard</p>
